...
export class SubscriptionClient {
  ...
  private processReceivedData(receivedData: any) {
    ...
    if (
      [MessageTypes.GQL_DATA, MessageTypes.GQL_COMPLETE, MessageTypes.GQL_ERROR].indexOf(
        parsedMessage.type,
      ) !== -1 &&
    ...
    switch (parsedMessage.type) {
      ...
      case MessageTypes.GQL_COMPLETE:
        this.operations[opId].handler(NULL_AS, null)
      ...
      case MessageTypes.GQL_DATA:
        ...
        this.operations[opId].handler(NULL_AS, parsedPayload)
        break
